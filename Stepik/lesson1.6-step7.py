...
browser.get("http://suninjuly.github.io/find_xpath_form") # Открываем сайт
...
try:
    ...
    button = browser.find_element(By.XPATH, "/html/body/div/form/div[6]/button[3]") # Поиск по селектору
    button.click()
